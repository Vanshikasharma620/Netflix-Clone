...
async function data(){
    ...
    sec2.innerHTML=`<img src=${respdata["ontv"]["img"]}>`;
    ...
    sec21.innerHTML=`<img src=${respdata["download"]["img"]}>`;
    ...
    sec211.innerHTML=`<img src=${respdata["everwhere"]["img"]}>`;
...
async function sec22(){
    const det= await fetch("./section.json");
    const respdata= await det.json();
